      ...
      <div className="flex flex-col" style={{ width: 280, minWidth: 260 }}>
        <div className="flex items-center justify-between mb-3 px-1">
          ...
          <button
            ...
            className="dh-btn-flat px-3 py-1.5"
      ...
      <div className="flex-1 flex flex-col min-h-0 gap-2">
        <Panel title="Efficiency & Performance Trends" className="flex-1 overflow-y-auto px-4 py-3">
          {flights.length < 2 ? (
            <div className="flex items-center justify-center h-full">
              <div className="dh-lcd label">Upload 2+ flights for trends</div>
            </div>
          ) : (
        ...
        <Panel noRivets className="p-3 flex gap-4 items-center">
          ...
          <button onClick={refetch}
            className="dh-subtitle" style={{ cursor: 'pointer', fontSize: '0.55rem' }}>
            ↺ Refresh
          </button>
        </Panel>
      </div>
