"""
Export helper module for Dark Hangar to generate:
...
def generate_pdf_report(flight_meta: dict, ts_data: dict) -> str:
    """
    Generate a high-quality PDF report aligned with the Dark Hangar
    aesthetics (dark background, glowing neon traces, grid statistics).
    """
    # ── Styling Config ────────────────────────────────────────────────────────
    bg_color = "#111625"
    panel_color = "#182030"
    ...
    ax_top.text(0.0, 0.9, "DARK HANGAR UAV FLIGHT ANALYZER", 
    ...
    fig.text(0.5, 0.02, "Generated by Dark Hangar Desktop Analyzer", 
